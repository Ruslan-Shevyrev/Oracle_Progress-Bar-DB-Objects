...
(ID 				NUMBER, 
 ...
 PROGRESS_PERCENT	number          NOT NULL);

ALTER TABLE PROGRESS_BAR ADD CONSTRAINT PROGRESS_BAR PRIMARY KEY (ID);
ALTER TABLE PROGRESS_BAR ADD CONSTRAINT FK_PROGRESS_BAR_STATUS FOREIGN KEY (STATUS_ID) REFERENCES PROGRESS_BAR_STATUS(ID);
...
BEGIN  
	...
	IF :NEW.PROGRESS_PERCENT NOT BETWEEN 0 AND 100 THEN 
		raise_application_error(-20555, 'Progress percentage must be between 0 and 100');
	END IF;
